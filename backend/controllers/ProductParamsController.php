...
use backend\models\ProductParamsSearch;
...
class ProductParamsController extends Controller
{
    ...
    /**
     * Updates an existing ProductParams model.
    ...
    /**
     * Deletes an existing ProductParams model.
    ...
    /**
     * Finds the ProductParams model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return ProductParams the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
